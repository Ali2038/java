...
public static void main(String[] args) {
        String cadNomeAluno = "Denys Alves da Silva";
        boolean estadoAluno = true;
    System.out.println("O nome completo do aluno é: " + cadNomeAluno);
    System.out.println("O estado do aluno é: " + estadoAluno);
}
}